    ...
    <>
      ...
      */}
        ...
        <div id="main-content" className={isLoaded ? "block" : "hidden"}>
          ...
          <section className="hero flex flex-col md:flex-row justify-between items-center py-10 px-5 bg-[radial-gradient(circle,rgba(0,30,60,0.8)_10%,rgba(0,0,0,1)_60%)] bg-fixed">
            <div className="hero-left flex-1 text-left">
              ...
              <p className="text-base md:text-lg text-gray-400 mb-5">
                Expert solutions for registrations, compliance, funding &
                certifications <br />
                all under one roof. Scale smarter with our tailored consultancy
                services.
              </p>
            </div>
            <div className="hero-right flex-1 flex justify-center items-center h-[60vh] md:h-[60vh]">
              ...
              >
                ...
                <g className="service-card" transform="translate(150,230)">
                  ...
                  <path
                    d="M35,45 L45,55 L60,45 L70,50 L85,40"
                    fill="none"
                    stroke="#fff"
                    strokeWidth="1.5"
                  />
                  ...
                  <animateTransform
                    attributeName="transform"
                    type="translate"
                    values="150,230;150,225;150,230"
                    dur="6s"
                    repeatCount="indefinite"
                    begin="0.5s"
                  />
                ...
                <g className="service-card" transform="translate(530,230)">
                  ...
                  <animateTransform
                    attributeName="transform"
                    type="translate"
                    values="530,230;530,225;530,230"
                    dur="7s"
                    repeatCount="indefinite"
                    begin="1.5s"
                  />
                ...
                >
                  <path
                    d="M400,170 C350,140 280,130 210,130"
                    stroke="#4cc9f0"
                    fill="none"
                  />
                  <path
                    d="M400,170 C450,140 520,130 590,130"
                    stroke="#4361ee"
                    fill="none"
                  />
                  <path
                    d="M400,170 C350,200 280,230 210,230"
                    stroke="#f72585"
                    fill="none"
                  />
                  <path
                    d="M400,170 C450,200 520,230 590,230"
                    stroke="#4ade80"
                    fill="none"
                  />
                </g>
          ...
          <section
            id="services"
            className="py-16 px-4 bg-[radial-gradient(circle,rgba(0,30,60,0.8)_10%,rgba(0,0,0,1)_60%)] bg-fixed text-center"
          >
              ...
              {[
                {
                  icon: (
                    ...
                    >
                      <rect
                        height="1"
                        transform="translate(22 51) rotate(180)"
                        width="18"
                        x="2"
                        y="25"
                        fill="#fff"
                      ...
                      <rect
                        height="1"
                        transform="translate(27 59) rotate(180)"
                        width="17"
                        x="5"
                        y="29"
                        fill="#fff"
                      ...
                      <rect
                        height="1"
                        transform="translate(40 -9) rotate(90)"
                        width="19"
                        x="15"
                        y="15"
                        fill="#fff"
                      ...
                      />
                      <path
                        d="M25,25H24v2a2,2,0,0,1-2,2h0v1h0a3,3,0,0,0,3-3Z"
                        fill="#fff"
                      />
                      <path
                        d="M19,26h1v1a2,2,0,0,0,2,2h0v1h0a3,3,0,0,1-3-3Z"
                        fill="#fff"
                      />
                      <path
                        d="M2,26H3v1a2,2,0,0,0,2,2H6v1H5a3,3,0,0,1-3-3Z"
                        fill="#fff"
                      />
                      <rect height="1" width="5" x="25" y="6" fill="#fff" />
                      <rect height="1" width="19" x="8" y="2" fill="#fff" />
                      <path
                        d="M5,6H6V5A2,2,0,0,1,8,3H9V2H8A3,3,0,0,0,5,5Z"
                        fill="#fff"
                      />
                      <path
                        d="M24,6h1V5a2,2,0,0,1,2-2h0V2h0a3,3,0,0,0-3,3Z"
                        fill="#fff"
                      />
                      <path
                        d="M30,6H29V5a2,2,0,0,0-2-2h0V2h0a3,3,0,0,1,3,3Z"
                        fill="#fff"
                      />
                      <path
                        d="M12,9a3,3,0,1,1,3,3A3,3,0,0,1,12,9Zm1,0a2,2,0,1,0,2-2A2,2,0,0,0,13,9Z"
                        fill="#fff"
                      />
                      <polygon
                        points="14 15 15 14 15 11 14 11 14 15"
                        fill="#fff"
                      />
                      <polygon
                        points="15 14 16 15 16 11 15 11 15 14"
                        fill="#fff"
                      />
                ...
                >
                  ...
                  <p className="service-desc text-sm text-gray-400 flex-grow">
                    {service.desc}
                  </p>
                  <Link
                    to={service.link}
