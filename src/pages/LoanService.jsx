...
const FundingServices = () => {
  ...
  const fundingDetails = {
    "Mudra Loan": {
      ...
      description: "The Pradhan Mantri MUDRA Yojana (PMMY) is a government-backed scheme providing financial support up to ₹10 lakhs to small businesses and entrepreneurs.",
      benefits: [
    ...
    "CGTMSE Loan": {
      ...
      description: "The Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE) scheme enables MSMEs to secure business loans without collateral up to ₹5 crores, backed by a government guarantee.",
      benefits: [
    ...
    "NAIFF Loan": {
      ...
      description: "The Nabard Agri Infra Financing Facility (NAIFF) provides up to ₹100 crores for agri-infrastructure projects with: 3% interest subvention (effective rate ~7-9%), Long repayment up to 10 years, 2-year moratorium available",
      benefits: [
    ...
    "PMEGP Loan": {
      ...
      description: "The Prime Minister's Employment Generation Programme (PMEGP) offers: 15-35% subsidy on project cost, Bank loans for remaining amount, Maximum project cost: ₹50 lakhs (manufacturing) / ₹20 lakhs (services)",
      benefits: [
  ...
  const fundingCards = [
    ...
    },
    {
      id: "CGTMSE Loan",
      title: "CGTMSE Loan - Collateral-Free Funding for MSMEs",
      description: "The Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE) scheme enables MSMEs to secure business loans without collateral up to ₹2 crores, backed by a government guarantee."
    },
    {
      id: "NAIFF Loan",
      title: "NABARD NAIFF Loan - Boost Your Agri-Business Infrastructure",
      description: "The Nabard Agri Infra Financing Facility (NAIFF) provides up to ₹100 crores for agri-infrastructure projects."
    },
    {
      id: "PMEGP Loan",
      title: "PMEGP Loan - Subsidized Funding for Entrepreneurs & MSMEs",
      description: "The Prime Minister's Employment Generation Programme (PMEGP) offers:"
    }
  ];
...
nav("/contact")
  ...
  const handleChatSend = () => {
    if (chatInput.trim()) {
      ...
      setTimeout(() => {
        setChatMessages(prev => [...prev, { type: 'bot', text: 'Thank you for your message! Our team will get back to you soon.' }]);
      }, 1000);
    }
  };
  ...
  const FundingCard = ({ card, index }) => (
    ...
    >
      ...
      <p className="mb-4 text-slate-300 flex-grow text-sm">{card.description}</p>
  ...
  const Modal = ({ isOpen, onClose, content }) => {
    ...
    return (
      <>
        <div className="fixed inset-0 bg-black/70 z-[9999] transition-opacity duration-300" onClick={onClose} />
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl p-5 max-w-[90%] w-[600px] max-h-[80vh] overflow-y-auto z-[99999] text-gray-800">
          ...
          <h2 className="text-blue-600 mb-5 text-2xl font-bold">{content.title}</h2>
          ...
          <h3 className="text-lg font-semibold mb-3 text-gray-800">Eligibility:</h3>
          <ul className="mb-5 pl-5 list-disc text-gray-700">
...
<Navbar/>
      ...
      <section className="flex flex-col items-center py-10 md:py-16 px-5 text-center">
        <h2 className="text-3xl md:text-4xl text-cyan-400 mb-5">Funding Solutions</h2>
        <p className="text-lg md:text-xl">Find the perfect funding option for your business growth</p>
      </section>
